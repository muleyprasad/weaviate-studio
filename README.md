...
- **RAG Chat:** Ask natural-language questions about your data—answers are generated by Weaviate's server-side LLM with retrieved context shown alongside
...
- Multi-collection support: select one or more collections as pill badges, add more from a dropdown
...
- Generated answer displayed with collapsible "Retrieved Context" section showing source objects, properties, and distance/certainty scores

...
module.exports = {
  ...
  entry: {
    ...
    'rag-chat': './src/rag-chat/webview/index.tsx',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: './src/rag-chat/webview/rag-chat.html',
      filename: 'rag-chat.html',
      chunks: ['rag-chat'],
      inject: 'body',
      scriptLoading: 'defer',
      minify: isProduction,
    ...
    new HtmlWebpackPlugin({
      template: './src/webview/rbac-role.html',
      filename: 'rbac-role.html',
      chunks: ['rbac-role'],
      inject: 'body',
      scriptLoading: 'defer',
      minify: isProduction,
    ...
    new HtmlWebpackPlugin({
      template: './src/webview/rbac-user.html',
      filename: 'rbac-user.html',
      chunks: ['rbac-user'],
      inject: 'body',
      scriptLoading: 'defer',
      minify: isProduction,
